...
public class ReplaceFragment extends NativeContainerFragment {
    ...
    @BindView(R.id.field_find) TextInputEditText mFieldFind;
    @BindView(R.id.checkbox_regex) CheckBox mCheckBox;
    @BindView(R.id.field_replace) TextInputEditText mFieldReplace;
    ...
    public void onActivityCreated(@Nullable Bundle savedInstanceState) {
        ...
        buttonSave.setOnClickListener(view -> {
            ...
            matchReplacePart = PatchBuilder.escapeComment(mFieldComment.getText().toString())
                    ...
                    + PatchBuilder.insertTag(mFieldReplace, "replace")
                    + PatchBuilder.insertEndTag("match_replace");
            StringWrapper.saveToPrefs(Constants.KEY_MATCH_REPLACE, matchReplacePart);
        ...
        buttonClear.setOnClickListener(view -> {
            ...
            mCheckBox.setChecked(Preferences.isForceRegexpAllowed());
            StringWrapper.saveToPrefs(Constants.KEY_MATCH_REPLACE, "");
        });
