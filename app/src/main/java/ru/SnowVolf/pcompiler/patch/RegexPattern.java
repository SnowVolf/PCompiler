...
public class RegexPattern {
    ...
    public static Pattern ATTRIBUTE = Pattern.compile("MIN_ENGINE_VER|AUTHOR|PACKAGE|MATCH_GOTO|MATCH_ASSIGN|MATCH_REPLACE|GOTO|ADD_FILES|REMOVE|FILES|MERGE|DUMMY|REGEX:|MATCH:|TARGET:|MERGE:|SOURCE:|DUMMY");
