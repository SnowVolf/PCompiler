...
/**
 * Created by Snow Volf on 24.09.2017, 4:45
 */

public class NativeBottomSheet extends AppCompatDialog {
    ...
    public NativeBottomSheet(@NonNull Context context) {
        this(context, ThemeWrapper.getTheme());
    }

    public NativeBottomSheet(@NonNull Context context, @StyleRes int theme) {
    ...
    protected NativeBottomSheet(@NonNull Context context, boolean cancelable,
